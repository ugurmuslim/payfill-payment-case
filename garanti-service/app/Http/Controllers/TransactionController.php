...
use App\Utils\Garanti\BankCommunication;
use App\Utils\Utils;
...
class TransactionController extends Controller
{
    ...
    {
        Log::info('Starting Garanti payment process');
        ...
        Log::info('Sending payment request to Garanti Bank', $requestBody);

        $response = $this->bankCommunication->processPayment($requestBody);

        Log::info('Received response from Garanti Bank', $response);
