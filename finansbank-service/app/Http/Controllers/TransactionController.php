...
class TransactionController extends Controller
{
    ...
    public function create(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        Log::info('Starting Finansbank payment process');
        ...
        Log::info('Sending payment request to Finansbank Bank', $requestBody);

        $response = $this->bankCommunication->processPayment($requestBody);

        Log::info('Received response from Finansbank Bank', $response);
